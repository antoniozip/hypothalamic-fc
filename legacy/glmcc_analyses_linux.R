...
regions_match_s2 <- read_excel("/home/antonio/Documents/tim_brown/regions_match_revision_May2023.xlsx", 
                                  sheet = "Sheet4")
...
png(filename = "/home/antonio/Documents/tim_brown/macroregions_pie_v2.png", width = 2560, height = 1440, units = "px")
...
png(filename = "/home/antonio/Documents/tim_brown/macroregions_dist_v2.png", width = 2560, height = 1440, units = "px")
...
df_171019 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171019_deg_wei")
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/degree_2way_171019_wei.png", width = 1860, height = 1440, units = "px")
...
df_171019 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171019_clus_wei")
nodeid <- rep(1:nrow(df_171019), 2);
condition <- c(rep("Ongoing",nrow(df_171019)), rep("LightON", nrow(df_171019)));
dat_171019 <- data.frame(c(df_171019$Ongoing, df_171019$LightON), condition, nodeid, rep(regions_171019,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/cluscoeff_2way_171019_wei.png", width = 1860, height = 1440, units = "px")
...
df_171019 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171019_localeff_wei")
nodeid <- rep(1:nrow(df_171019), 2);
condition <- c(rep("Ongoing",nrow(df_171019)), rep("LightON", nrow(df_171019)));
dat_171019 <- data.frame(c(df_171019$Ongoing, df_171019$LightON), condition, nodeid, rep(regions_171019,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/localEff_2way_171019_wei.png", width = 1860, height = 1440, units = "px")
...
###################################################################################################
df_171207 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171207_deg_wei")
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/degree_2way_171207_wei.png", width = 1860, height = 1440, units = "px")
...
df_171207 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171207_clus_wei")
nodeid <- rep(1:nrow(df_171207), 2);
condition <- c(rep("Ongoing",nrow(df_171207)), rep("LightON", nrow(df_171207)));
dat_171207 <- data.frame(c(df_171207$Ongoing, df_171207$LightON), condition, nodeid, rep(regions_171207,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/cluscoeff_2way_171207_wei.png", width = 1860, height = 1440, units = "px")
...
df_171207 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171207_localeff_wei")
nodeid <- rep(1:nrow(df_171207), 2);
condition <- c(rep("Ongoing",nrow(df_171207)), rep("LightON", nrow(df_171207)));
dat_171207 <- data.frame(c(df_171207$Ongoing, df_171207$LightON), condition, nodeid, rep(regions_171207,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/localEff_2way_171207_wei.png", width = 1860, height = 1440, units = "px")
...
###############################################################################
df_171208 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171208_deg_wei")
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/degree_2way_171208_wei.png", width = 1860, height = 1440, units = "px")
...
df_171208 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171208_clus_wei")
nodeid <- rep(1:nrow(df_171208), 2);
condition <- c(rep("Ongoing",nrow(df_171208)), rep("LightON", nrow(df_171208)));
dat_171208 <- data.frame(c(df_171208$Ongoing, df_171208$LightON), condition, nodeid, rep(regions_171208,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/cluscoeff_2way_171208_wei.png", width = 1860, height = 1440, units = "px")
...
df_171208 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171208_localeff_wei")
nodeid <- rep(1:nrow(df_171208), 2);
condition <- c(rep("Ongoing",nrow(df_171208)), rep("LightON", nrow(df_171208)));
dat_171208 <- data.frame(c(df_171208$Ongoing, df_171208$LightON), condition, nodeid, rep(regions_171208,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/localEff_2way_171208_wei.png", width = 1860, height = 1440, units = "px")
...
##################################################################################################
df_171213 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171213_deg_wei")
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/degree_2way_171213_wei.png", width = 1860, height = 1440, units = "px")
...
df_171213 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171213_clus_wei")
nodeid <- rep(1:nrow(df_171213), 2);
condition <- c(rep("Ongoing",nrow(df_171213)), rep("LightON", nrow(df_171213)));
dat_171213 <- data.frame(c(df_171213$Ongoing, df_171213$LightON), condition, nodeid, rep(regions_171213,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/cluscoeff_2way_171213_wei.png", width = 1860, height = 1440, units = "px")
...
df_171213 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171213_localeff_wei")
nodeid <- rep(1:nrow(df_171213), 2);
condition <- c(rep("Ongoing",nrow(df_171213)), rep("LightON", nrow(df_171213)));
dat_171213 <- data.frame(c(df_171213$Ongoing, df_171213$LightON), condition, nodeid, rep(regions_171213,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/localEff_2way_171213_wei.png", width = 1860, height = 1440, units = "px")
...
################################################################################################################################
df_180110 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180110_deg_wei")
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/degree_2way_180110_wei.png", width = 1860, height = 1440, units = "px")
...
df_180110 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180110_clus_wei")
nodeid <- rep(1:nrow(df_180110), 2);
condition <- c(rep("Ongoing",nrow(df_180110)), rep("LightON", nrow(df_180110)));
dat_180110 <- data.frame(c(df_180110$Ongoing, df_180110$LightON), condition, nodeid, rep(regions_180110,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/cluscoeff_2way_180110_wei.png", width = 1860, height = 1440, units = "px")
...
df_180110 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180110_localeff_wei")
nodeid <- rep(1:nrow(df_180110), 2);
condition <- c(rep("Ongoing",nrow(df_180110)), rep("LightON", nrow(df_180110)));
dat_180110 <- data.frame(c(df_180110$Ongoing, df_180110$LightON), condition, nodeid, rep(regions_180110,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/localEff_2way_180110_wei.png", width = 1860, height = 1440, units = "px")
...
##############################################################################################
df_180111 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180111_deg_wei")
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/degree_2way_180111_wei.png", width = 1860, height = 1440, units = "px")
...
df_180111 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180111_clus_wei")
nodeid <- rep(1:nrow(df_180111), 2);
condition <- c(rep("Ongoing",nrow(df_180111)), rep("LightON", nrow(df_180111)));
dat_180111 <- data.frame(c(df_180111$Ongoing, df_180111$LightON), condition, nodeid, rep(regions_180111,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/cluscoeff_2way_180111_wei.png", width = 1860, height = 1440, units = "px")
...
df_180111 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180111_localeff_wei")
nodeid <- rep(1:nrow(df_180111), 2);
condition <- c(rep("Ongoing",nrow(df_180111)), rep("LightON", nrow(df_180111)));
dat_180111 <- data.frame(c(df_180111$Ongoing, df_180111$LightON), condition, nodeid, rep(regions_180111,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/localEff_2way_180111_wei.png", width = 1860, height = 1440, units = "px")
...
##############################################################################################################
df_180131 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180131_deg_wei")
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/degree_2way_180131_wei.png", width = 1860, height = 1440, units = "px")
...
df_180131 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180131_clus_wei")
nodeid <- rep(1:nrow(df_180131), 2);
condition <- c(rep("Ongoing",nrow(df_180131)), rep("LightON", nrow(df_180131)));
dat_180131 <- data.frame(c(df_180131$Ongoing, df_180131$LightON), condition, nodeid, rep(regions_180131,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/cluscoeff_2way_180131_wei.png", width = 1860, height = 1440, units = "px")
...
df_180131 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180131_localeff_wei")
nodeid <- rep(1:nrow(df_180131), 2);
condition <- c(rep("Ongoing",nrow(df_180131)), rep("LightON", nrow(df_180131)));
dat_180131 <- data.frame(c(df_180131$Ongoing, df_180131$LightON), condition, nodeid, rep(regions_180131,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/localEff_2way_180131_wei.png", width = 1860, height = 1440, units = "px")
...
########################################################################################################################
df_180221 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180221_deg_wei")
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/degree_2way_180221_wei.png", width = 1860, height = 1440, units = "px")
...
df_180221 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180221_clus_wei")
nodeid <- rep(1:nrow(df_180221), 2);
condition <- c(rep("Ongoing",nrow(df_180221)), rep("LightON", nrow(df_180221)));
dat_180221 <- data.frame(c(df_180221$Ongoing, df_180221$LightON), condition, nodeid, rep(regions_180221,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/cluscoeff_2way_180221_wei.png", width = 1860, height = 1440, units = "px")
...
df_180221 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180221_localeff_wei")
nodeid <- rep(1:nrow(df_180221), 2);
condition <- c(rep("Ongoing",nrow(df_180221)), rep("LightON", nrow(df_180221)));
dat_180221 <- data.frame(c(df_180221$Ongoing, df_180221$LightON), condition, nodeid, rep(regions_180221,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/localEff_2way_180221_wei.png", width = 1860, height = 1440, units = "px")
...
df_180228 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180228_deg_wei")
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/degree_2way_180228_wei.png", width = 1860, height = 1440, units = "px")
...
df_180228 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180228_clus_wei")
nodeid <- rep(1:nrow(df_180228), 2);
condition <- c(rep("Ongoing",nrow(df_180228)), rep("LightON", nrow(df_180228)));
dat_180228 <- data.frame(c(df_180228$Ongoing, df_180228$LightON), condition, nodeid, rep(regions_180228,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/cluscoeff_2way_180228_wei.png", width = 1860, height = 1440, units = "px")
...
df_180228 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180228_localeff_wei")
nodeid <- rep(1:nrow(df_180228), 2);
condition <- c(rep("Ongoing",nrow(df_180228)), rep("LightON", nrow(df_180228)));
dat_180228 <- data.frame(c(df_180228$Ongoing, df_180228$LightON), condition, nodeid, rep(regions_180228,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/localEff_2way_180228_wei.png", width = 1860, height = 1440, units = "px")
...
df_180302 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180302_deg_wei")
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/degree_2way_180302_wei_v2.png", width = 1860, height = 1440, units = "px")
...
df_180302 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180302_clus_wei")
nodeid <- rep(1:nrow(df_180302), 2);
condition <- c(rep("Ongoing",nrow(df_180302)), rep("LightON", nrow(df_180302)));
dat_180302 <- data.frame(c(df_180302$Ongoing, df_180302$LightON), condition, nodeid, rep(regions_180302,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/cluscoeff_2way_180302_wei_v2.png", width = 1860, height = 1440, units = "px")
...
df_180302 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180302_localeff_wei")
nodeid <- rep(1:nrow(df_180302), 2);
condition <- c(rep("Ongoing",nrow(df_180302)), rep("LightON", nrow(df_180302)));
dat_180302 <- data.frame(c(df_180302$Ongoing, df_180302$LightON), condition, nodeid, rep(regions_180302,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/localEff_2way_180302_wei_v2.png", width = 1860, height = 1440, units = "px")
...
################################################################################################################################
df_180419 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180419_deg_wei")
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/degree_2way_180419_wei.png", width = 1860, height = 1440, units = "px")
...
df_180419 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180419_clus_wei")
nodeid <- rep(1:nrow(df_180419), 2);
condition <- c(rep("Ongoing",nrow(df_180419)), rep("LightON", nrow(df_180419)));
dat_180419 <- data.frame(c(df_180419$Ongoing, df_180419$LightON), condition, nodeid, rep(regions_180419,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/cluscoeff_2way_180419_wei.png", width = 1860, height = 1440, units = "px")
...
df_180419 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180419_localeff_wei")
nodeid <- rep(1:nrow(df_180419), 2);
condition <- c(rep("Ongoing",nrow(df_180419)), rep("LightON", nrow(df_180419)));
dat_180419 <- data.frame(c(df_180419$Ongoing, df_180419$LightON), condition, nodeid, rep(regions_180419,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/localEff_2way_180419_wei.png", width = 1860, height = 1440, units = "px")
...
########################################################################################################################
df_180420 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180420_deg_wei")
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/degree_2way_180420_wei_v2.png", width = 1860, height = 1440, units = "px")
...
df_180420 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180420_clus_wei")
nodeid <- rep(1:nrow(df_180420), 2);
condition <- c(rep("Ongoing",nrow(df_180420)), rep("LightON", nrow(df_180420)));
dat_180420 <- data.frame(c(df_180420$Ongoing, df_180420$LightON), condition, nodeid, rep(regions_180420,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/cluscoeff_2way_180420_wei_v2.png", width = 1860, height = 1440, units = "px")
...
df_180420 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180420_localeff_wei")
nodeid <- rep(1:nrow(df_180420), 2);
condition <- c(rep("Ongoing",nrow(df_180420)), rep("LightON", nrow(df_180420)));
dat_180420 <- data.frame(c(df_180420$Ongoing, df_180420$LightON), condition, nodeid, rep(regions_180420,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/localEff_2way_180420_wei_v2.png", width = 1860, height = 1440, units = "px")
...
df_180423 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180423_deg_wei")
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/degree_2way_180423_wei_v2.png", width = 1860, height = 1440, units = "px")
...
df_180423 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180423_clus_wei")
nodeid <- rep(1:nrow(df_180423), 2);
condition <- c(rep("Ongoing",nrow(df_180423)), rep("LightON", nrow(df_180423)));
dat_180423 <- data.frame(c(df_180423$Ongoing, df_180423$LightON), condition, nodeid, rep(regions_180423,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/cluscoeff_2way_180423_wei_v2.png", width = 1860, height = 1440, units = "px")
...
df_180423 <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180423_localeff_wei")
nodeid <- rep(1:nrow(df_180423), 2);
condition <- c(rep("Ongoing",nrow(df_180423)), rep("LightON", nrow(df_180423)));
dat_180423 <- data.frame(c(df_180423$Ongoing, df_180423$LightON), condition, nodeid, rep(regions_180423,2));
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/localEff_2way_180423_wei_v2.png", width = 1860, height = 1440, units = "px")
...
png(filename = "/home/antonio/Documents/tim_brown/GLMCC/strength_3way.png", width = 1240, height = 2840, units = "px")
plot(emm1, xlab = "Node Strength", ylab="") + theme(text = element_text(size = 34))
dev.off()

write.csv2(df_degree[which(df_degree$region == "paraventricular hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/pv_ht_3way.csv")
write.csv2(df_degree[which(df_degree$region == "ventromedial hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/vm_ht_3way.csv")
write.csv2(df_degree[which(df_degree$region == "posterior hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/p_ht_3way.csv")
write.csv2(df_degree[which(df_degree$region == "arcuate hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/arc_ht_3way.csv")
write.csv2(df_degree[which(df_degree$region == "zona incerta"),], "/home/antonio/Documents/tim_brown/GLMCC/zi_3way.csv")
write.csv2(df_degree[which(df_degree$region == "mammillary complex"),], "/home/antonio/Documents/tim_brown/GLMCC/mm_complex_3way.csv")
write.csv2(df_degree[which(df_degree$region == "anterior hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/a_ht_3way.csv")
write.csv2(df_degree[which(df_degree$region == "dorsomedial hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/dm_ht_3way.csv")
write.csv2(df_degree[which(df_degree$region == "ventromedial thalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/vm_t_3way.csv")
...
write.csv2(df_cluscoeff[which(df_cluscoeff$region == "paraventricular hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/pv_ht_3way_cc.csv")
write.csv2(df_cluscoeff[which(df_cluscoeff$region == "ventromedial hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/vm_ht_3way_cc.csv")
write.csv2(df_cluscoeff[which(df_cluscoeff$region == "posterior hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/p_ht_3way_cc.csv")
write.csv2(df_cluscoeff[which(df_cluscoeff$region == "arcuate hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/arc_ht_3way_cc.csv")
write.csv2(df_cluscoeff[which(df_cluscoeff$region == "zona incerta"),], "/home/antonio/Documents/tim_brown/GLMCC/zi_3way_cc.csv")
write.csv2(df_cluscoeff[which(df_cluscoeff$region == "mammillary complex"),], "/home/antonio/Documents/tim_brown/GLMCC/mm_complex_3way_cc.csv")
write.csv2(df_cluscoeff[which(df_cluscoeff$region == "anterior hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/a_ht_3way_cc.csv")
write.csv2(df_cluscoeff[which(df_cluscoeff$region == "dorsomedial hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/dm_ht_3way_cc.csv")
write.csv2(df_cluscoeff[which(df_cluscoeff$region == "ventromedial thalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/vm_t_3way_cc.csv")
...
write.csv2(df_loceff[which(df_loceff$region == "paraventricular hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/pv_ht_3way_le.csv")
write.csv2(df_loceff[which(df_loceff$region == "ventromedial hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/vm_ht_3way_le.csv")
write.csv2(df_loceff[which(df_loceff$region == "posterior hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/p_ht_3way_le.csv")
write.csv2(df_loceff[which(df_loceff$region == "arcuate hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/arc_ht_3way_le.csv")
write.csv2(df_loceff[which(df_loceff$region == "zona incerta"),], "/home/antonio/Documents/tim_brown/GLMCC/zi_3way_le.csv")
write.csv2(df_loceff[which(df_loceff$region == "mammillary complex"),], "/home/antonio/Documents/tim_brown/GLMCC/mm_complex_3way_le.csv")
write.csv2(df_loceff[which(df_loceff$region == "anterior hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/a_ht_3way_le.csv")
write.csv2(df_loceff[which(df_loceff$region == "dorsomedial hypothalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/dm_ht_3way_le.csv")
write.csv2(df_loceff[which(df_loceff$region == "ventromedial thalamus"),], "/home/antonio/Documents/tim_brown/GLMCC/vm_t_3way_le.csv")
...
####################################################################################
######################## 171019 #########################
adj_pearson_171019 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/prestimulus_pycharm/result_GLMCC_prestimulus_171019_pycharm.csv", header=FALSE)
...
write.csv(conn_171019, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_171019.csv");
sel_mat <- which(conn_171019 > quantile(conn_171019, .75), arr.ind = TRUE);
net_171019 <- network(conn_171019, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_171019.png", res=600,  units = "in",  width = 26, height = 16)
...
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171019_fr")
...
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171019_clus_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
clus_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171019_deg_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
deg_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171019_localeff_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_ongoing_171019.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
...
################################### EVOKED ############################################################
adj_pearson_171019 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_171019_pycharm.csv", header=FALSE)
adj_pearson_171019 <- as.matrix(adj_pearson_171019);
colnames(adj_pearson_171019) <- regions_171019;
rownames(adj_pearson_171019) <- regions_171019;
plot(adj_pearson_171019)
...
write.csv(conn_171019, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_171019.csv");
sel_mat <- which(conn_171019 > quantile(conn_171019, .7), arr.ind = TRUE);
net_171019 <- network(conn_171019, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_171019.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_171019, label = unique(rownames(conn_171019)), edge.label = conn_171019, label.cex=2, edge.label.cex=2)
dev.off()
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_evoked_171019.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
####################################################################################
######################## 171207 #########################
adj_pearson_171207 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/prestimulus_pycharm/result_GLMCC_prestimulus_171207_pycharm.csv", header=FALSE)
...
write.csv(conn_171207, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_171207.csv");
sel_mat <- which(conn_171207 > quantile(conn_171207, .75), arr.ind = TRUE);
net_171207 <- network(conn_171207, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_171207.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_171207, label = unique(rownames(conn_171207)), edge.label = conn_171207, label.cex=2, edge.label.cex=2)
dev.off()

col_fun = colorRamp2( seq(-0.6,0.6,0.12), rev(brewer.pal(n = length(seq(-0.6,0.6,0.12)), name = "RdBu")), transparency = 0)

df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171207_fr")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
fr_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171207_clus_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
clus_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171207_deg_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
deg_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171207_localeff_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_ongoing_171207.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
################################### EVOKED ############################################################
adj_pearson_171207 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_171207_pycharm.csv", header=FALSE)
adj_pearson_171207 <- as.matrix(adj_pearson_171207);
colnames(adj_pearson_171207) <- regions_171207;
rownames(adj_pearson_171207) <- regions_171207;
plot(adj_pearson_171207)
...
write.csv(conn_171207, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_171207.csv");
sel_mat <- which(conn_171207 > quantile(conn_171207, .75), arr.ind = TRUE);
net_171207 <- network(conn_171207, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_171207.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_171207, label = unique(rownames(conn_171207)), edge.label = conn_171207, label.cex=2, edge.label.cex=2)
dev.off()
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_evoked_171207.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
####################################################################################
######################## 171208 #########################
adj_pearson_171208 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/prestimulus_pycharm/result_GLMCC_prestimulus_171208_pycharm.csv", header=FALSE)
...
write.csv(conn_171208, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_171208.csv");
sel_mat <- which(conn_171208 > quantile(conn_171208, .75), arr.ind = TRUE);
net_171208 <- network(conn_171208, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_171208.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_171208, label = unique(rownames(conn_171208)), edge.label = conn_171208, label.cex=2, edge.label.cex=2)
dev.off()

col_fun = colorRamp2( seq(-0.6,0.6,0.12), rev(brewer.pal(n = length(seq(-0.6,0.6,0.12)), name = "RdBu")), transparency = 0)

df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171208_fr")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
fr_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171208_clus_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
clus_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171208_deg_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
deg_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171208_localeff_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_ongoing_171208.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
################################### EVOKED ############################################################
adj_pearson_171208 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_171208_pycharm.csv", header=FALSE)
adj_pearson_171208 <- as.matrix(adj_pearson_171208);
colnames(adj_pearson_171208) <- regions_171208;
rownames(adj_pearson_171208) <- regions_171208;
plot(adj_pearson_171208)
...
write.csv(conn_171208, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_171208.csv");
sel_mat <- which(conn_171208 > quantile(conn_171208, .75), arr.ind = TRUE);
net_171208 <- network(conn_171208, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_171208.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_171208, label = unique(rownames(conn_171208)), edge.label = conn_171208, label.cex=2, edge.label.cex=2)
dev.off()
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_evoked_171208.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
####################################################################################
######################## 171213 #########################
adj_pearson_171213 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/prestimulus_pycharm/result_GLMCC_prestimulus_171213_pycharm.csv", header=FALSE)
...
write.csv(conn_171213, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_171213.csv");
sel_mat <- which(conn_171213 > quantile(conn_171213, .75), arr.ind = TRUE);
net_171213 <- network(conn_171213, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_171213.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_171213, label = unique(rownames(conn_171213)), edge.label = conn_171213, label.cex=2, edge.label.cex=2)
dev.off()

col_fun = colorRamp2( seq(-0.6,0.6,0.12), rev(brewer.pal(n = length(seq(-0.6,0.6,0.12)), name = "RdBu")), transparency = 0)

df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171213_fr")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
fr_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171213_clus_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
clus_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171213_deg_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
deg_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="171213_localeff_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_ongoing_171213.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
################################### EVOKED ############################################################
adj_pearson_171213 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_171213_pycharm.csv", header=FALSE)
adj_pearson_171213 <- as.matrix(adj_pearson_171213);
colnames(adj_pearson_171213) <- regions_171213;
rownames(adj_pearson_171213) <- regions_171213;
plot(adj_pearson_171213)
...
write.csv(conn_171213, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_171213.csv");
sel_mat <- which(conn_171213 > quantile(conn_171213, .75), arr.ind = TRUE);
net_171213 <- network(conn_171213, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_171213.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_171213, label = unique(rownames(conn_171213)), edge.label = conn_171213, label.cex=2, edge.label.cex=2)
dev.off()
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_evoked_171213.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
####################################################################################
######################## 180110 #########################
adj_pearson_180110 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/prestimulus_pycharm/result_GLMCC_prestimulus_180110_pycharm.csv", header=FALSE)
...
write.csv(conn_180110, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180110.csv");
sel_mat <- which(conn_180110 > quantile(conn_180110, .75), arr.ind = TRUE);
net_180110 <- network(conn_180110, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180110.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180110, label = unique(rownames(conn_180110)), edge.label = conn_180110, label.cex=2, edge.label.cex=2)
dev.off()

col_fun = colorRamp2( seq(-0.6,0.6,0.12), rev(brewer.pal(n = length(seq(-0.6,0.6,0.12)), name = "RdBu")), transparency = 0)

df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180110_fr")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
fr_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180110_clus_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
clus_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180110_deg_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
deg_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180110_localeff_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_ongoing_180110.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
################################### EVOKED ############################################################
adj_pearson_180110 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180110_pycharm.csv", header=FALSE, sep = "\t")
adj_pearson_180110 <- as.matrix(adj_pearson_180110);
colnames(adj_pearson_180110) <- regions_180110;
rownames(adj_pearson_180110) <- regions_180110;
plot(adj_pearson_180110)
...
write.csv(conn_180110, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180110.csv");
sel_mat <- which(conn_180110 > quantile(conn_180110, .75), arr.ind = TRUE);
net_180110 <- network(conn_180110, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180110.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180110, label = unique(rownames(conn_180110)), edge.label = conn_180110, label.cex=2, edge.label.cex=2 )
dev.off()
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_evoked_180110.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
####################################################################################
######################## 180111 #########################
adj_pearson_180111 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/prestimulus_pycharm/result_GLMCC_prestimulus_180111_pycharm.csv", header=FALSE)
...
write.csv(conn_180111, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180111.csv");
sel_mat <- which(conn_180111 > quantile(conn_180111, .75), arr.ind = TRUE);
net_180111 <- network(conn_180111, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180111.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180111, label = unique(rownames(conn_180111)), edge.label = conn_180111, label.cex=2, edge.label.cex=2)
dev.off()

col_fun = colorRamp2( seq(-0.6,0.6,0.12), rev(brewer.pal(n = length(seq(-0.6,0.6,0.12)), name = "RdBu")), transparency = 0)

df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180111_fr")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
fr_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180111_clus_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
clus_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180111_deg_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
deg_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180111_localeff_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_ongoing_180111.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
################################### EVOKED ############################################################
adj_pearson_180111 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180111_pycharm.csv", header=FALSE, sep = ",")
adj_pearson_180111 <- as.matrix(adj_pearson_180111);
colnames(adj_pearson_180111) <- regions_180111;
rownames(adj_pearson_180111) <- regions_180111;
plot(adj_pearson_180111)
...
write.csv(conn_180111, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180111.csv");
sel_mat <- which(conn_180111 > quantile(conn_180111, .75), arr.ind = TRUE);
net_180111 <- network(conn_180111, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180111.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180111, label = unique(rownames(conn_180111)), edge.label = conn_180111, label.cex=2, edge.label.cex=2)
dev.off()
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_evoked_180111.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
####################################################################################
######################## 180131 #########################
adj_pearson_180131 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/prestimulus_pycharm/result_GLMCC_prestimulus_180131_pycharm.csv", header=FALSE)
...
write.csv(conn_180131, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180131.csv");
sel_mat <- which(conn_180131 > quantile(conn_180131, .75), arr.ind = TRUE);
net_180131 <- network(conn_180131, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180131.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180131, label = unique(rownames(conn_180131)), edge.label = conn_180131, label.cex=2, edge.label.cex=2)
dev.off()

col_fun = colorRamp2( seq(-0.6,0.6,0.12), rev(brewer.pal(n = length(seq(-0.6,0.6,0.12)), name = "RdBu")), transparency = 0)

df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180131_fr")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
fr_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180131_clus_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
clus_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180131_deg_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
deg_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180131_localeff_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_ongoing_180131.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
################################### EVOKED ############################################################
adj_pearson_180131 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180131_pycharm.csv", header=FALSE, sep = ",")
adj_pearson_180131 <- as.matrix(adj_pearson_180131);
colnames(adj_pearson_180131) <- regions_180131;
rownames(adj_pearson_180131) <- regions_180131;
plot(adj_pearson_180131)
...
write.csv(conn_180131, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180131.csv");
sel_mat <- which(conn_180131 > quantile(conn_180131, .75), arr.ind = TRUE);
net_180131 <- network(conn_180131, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180131.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180131, label = unique(rownames(conn_180131)), edge.label = conn_180131, label.cex=2, edge.label.cex=2)
dev.off()
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_evoked_180131.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
####################################################################################
######################## 180221 #########################
adj_pearson_180221 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/prestimulus_pycharm/result_GLMCC_prestimulus_180221_pycharm.csv", header=FALSE)
...
write.csv(conn_180221, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180221.csv");
sel_mat <- which(conn_180221 > quantile(conn_180221, .75), arr.ind = TRUE);
net_180221 <- network(conn_180221, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180221.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180221, label = unique(rownames(conn_180221)), edge.label = conn_180221, label.cex=2, edge.label.cex=2)
dev.off()

col_fun = colorRamp2( seq(-0.6,0.6,0.12), rev(brewer.pal(n = length(seq(-0.6,0.6,0.12)), name = "RdBu")), transparency = 0)

df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180221_fr")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
fr_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180221_clus_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
clus_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180221_deg_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
deg_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180221_localeff_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_ongoing_180221.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
################################### EVOKED ############################################################
adj_pearson_180221 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180221_pycharm.csv", header=FALSE, sep = ",")
adj_pearson_180221 <- as.matrix(adj_pearson_180221);
colnames(adj_pearson_180221) <- regions_180221;
rownames(adj_pearson_180221) <- regions_180221;
plot(adj_pearson_180221)
...
write.csv(conn_180221, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180221.csv");
sel_mat <- which(conn_180221 > quantile(conn_180221, .75), arr.ind = TRUE);
net_180221 <- network(conn_180221, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180221.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180221, label = unique(rownames(conn_180221)), edge.label = conn_180221, label.cex=2, edge.label.cex=2)
dev.off()
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_evoked_180221.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
####################################################################################
######################## 180228 #########################
adj_pearson_180228 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/prestimulus_pycharm/result_GLMCC_prestimulus_180228_pycharm.csv", header=FALSE)
...
write.csv(conn_180228, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180228.csv");
sel_mat <- which(conn_180228 > quantile(conn_180228, .75), arr.ind = TRUE);
net_180228 <- network(conn_180228, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180228.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180228, label = unique(rownames(conn_180228)), edge.label = conn_180228, label.cex=2, edge.label.cex=2)
dev.off()

col_fun = colorRamp2( seq(-0.6,0.6,0.12), rev(brewer.pal(n = length(seq(-0.6,0.6,0.12)), name = "RdBu")), transparency = 0)

df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180228_fr")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
fr_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180228_clus_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
clus_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180228_deg_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
deg_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180228_localeff_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_ongoing_180228.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
################################### EVOKED ############################################################
adj_pearson_180228 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180228_pycharm.csv", header=FALSE, sep = ",")
adj_pearson_180228 <- as.matrix(adj_pearson_180228);
colnames(adj_pearson_180228) <- regions_180228;
rownames(adj_pearson_180228) <- regions_180228;
plot(adj_pearson_180228)
...
write.csv(conn_180228, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180228.csv");
sel_mat <- which(conn_180228 > quantile(conn_180228, .75), arr.ind = TRUE);
net_180228 <- network(conn_180228, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180228.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180228, label = unique(rownames(conn_180228)), edge.label = conn_180228, label.cex=2, edge.label.cex=2)
dev.off()
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_evoked_180228.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
####################################################################################
######################## 180302 #########################
adj_pearson_180302 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/prestimulus_pycharm/result_GLMCC_prestimulus_180302_pycharm.csv", header=FALSE)
...
write.csv(conn_180302, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180302.csv");
sel_mat <- which(conn_180302 > quantile(conn_180302, .75), arr.ind = TRUE);
net_180302 <- network(conn_180302, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180302.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180302, label = unique(rownames(conn_180302)), edge.label = conn_180302, label.cex=2, edge.label.cex=2)
dev.off()

col_fun = colorRamp2( seq(-0.6,0.6,0.12), rev(brewer.pal(n = length(seq(-0.6,0.6,0.12)), name = "RdBu")), transparency = 0)

df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180302_fr")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
fr_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180302_clus_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
clus_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180302_deg_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
deg_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180302_localeff_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_ongoing_180302.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
################################### EVOKED ############################################################
adj_pearson_180302 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180302_pycharm.csv", header=FALSE, sep = ",")
adj_pearson_180302 <- as.matrix(adj_pearson_180302);
colnames(adj_pearson_180302) <- regions_180302;
rownames(adj_pearson_180302) <- regions_180302;
plot(adj_pearson_180302)
...
write.csv(conn_180302, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180302.csv");
sel_mat <- which(conn_180302 > quantile(conn_180302, .75), arr.ind = TRUE);
net_180302 <- network(conn_180302, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180302.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180302, label = unique(rownames(conn_180302)), edge.label = conn_180302, label.cex=2, edge.label.cex=2)
dev.off()
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_evoked_180302.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
####################################################################################
######################## 180419 #########################
adj_pearson_180419 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/prestimulus_pycharm/result_GLMCC_prestimulus_180419_pycharm.csv", header=FALSE)
...
write.csv(conn_180419, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180419.csv");
sel_mat <- which(conn_180419 > quantile(conn_180419, .75), arr.ind = TRUE);
net_180419 <- network(conn_180419, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180419.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180419, label = unique(rownames(conn_180419)), edge.label = conn_180419, label.cex=2, edge.label.cex=2)
dev.off()

col_fun = colorRamp2( seq(-0.6,0.6,0.12), rev(brewer.pal(n = length(seq(-0.6,0.6,0.12)), name = "RdBu")), transparency = 0)

df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180419_fr")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
fr_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180419_clus_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
clus_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180419_deg_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
deg_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180419_localeff_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_ongoing_180419.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
################################### EVOKED ############################################################
adj_pearson_180419 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180419_pycharm.csv", header=FALSE, sep = ",")
adj_pearson_180419 <- as.matrix(adj_pearson_180419);
colnames(adj_pearson_180419) <- regions_180419;
rownames(adj_pearson_180419) <- regions_180419;
plot(adj_pearson_180419)
...
write.csv(conn_180419, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180419.csv");
sel_mat <- which(conn_180419 > quantile(conn_180419, .75), arr.ind = TRUE);
net_180419 <- network(conn_180419, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180419.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180419, label = unique(rownames(conn_180419)), edge.label = conn_180419, label.cex=2, edge.label.cex=2)
dev.off()
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_evoked_180419.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
####################################################################################
######################## 180420 #########################
adj_pearson_180420 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/prestimulus_pycharm/result_GLMCC_prestimulus_180420_pycharm.csv", header=FALSE)
...
write.csv(conn_180420, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180420.csv");
sel_mat <- which(conn_180420 > quantile(conn_180420, .75), arr.ind = TRUE);
net_180420 <- network(conn_180420, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180420.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180420, label = unique(rownames(conn_180420)), edge.label = conn_180420, label.cex=2, edge.label.cex=2)
dev.off()

col_fun = colorRamp2( seq(-0.6,0.6,0.12), rev(brewer.pal(n = length(seq(-0.6,0.6,0.12)), name = "RdBu")), transparency = 0)

df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180420_fr")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
fr_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180420_clus_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
clus_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180420_deg_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
deg_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180420_localeff_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_ongoing_180420.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
################################### EVOKED ############################################################
adj_pearson_180420 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180420_pycharm.csv", header=FALSE, sep = ",")
adj_pearson_180420 <- as.matrix(adj_pearson_180420);
colnames(adj_pearson_180420) <- regions_180420;
rownames(adj_pearson_180420) <- regions_180420;
plot(adj_pearson_180420)
...
write.csv(conn_180420, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180420.csv");
sel_mat <- which(conn_180420 > quantile(conn_180420, .75), arr.ind = TRUE);
net_180420 <- network(conn_180420, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180420.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180420, label = unique(rownames(conn_180420)) , edge.label = conn_180420, label.cex=2, edge.label.cex=2)
dev.off()
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_evoked_180420.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
####################################################################################
######################## 180423 #########################
adj_pearson_180423 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/prestimulus_pycharm/result_GLMCC_prestimulus_180423_pycharm.csv", header=FALSE)
...
write.csv(conn_180423, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180423.csv");
sel_mat <- which(conn_180423 > quantile(conn_180423, .75), arr.ind = TRUE);
net_180423 <- network(conn_180423, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_180423.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180423, label = unique(rownames(conn_180423)), edge.label = conn_180423, label.cex=2, edge.label.cex=2)
dev.off()

col_fun = colorRamp2( seq(-0.6,0.6,0.12), rev(brewer.pal(n = length(seq(-0.6,0.6,0.12)), name = "RdBu")), transparency = 0)

df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180423_fr")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
fr_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180423_clus_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
clus_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180423_deg_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
deg_col = col_fun_metric(df$Ongoing)
df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", table="180423_localeff_wei")
df$Ongoing <- as.numeric(sub(",", ".",df$Ongoing, fixed=TRUE))
df$LightON <- as.numeric(sub(",", ".",df$LightON, fixed=TRUE))
col_fun_metric = colorRamp2( seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10), 
                             rev(brewer.pal(n = length(seq(min(df$Ongoing),max(df$Ongoing), (max(df$Ongoing) - min(df$Ongoing))/10)), name = "PRGn")), transparency = 0)
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_ongoing_180423.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
################################### EVOKED ############################################################
adj_pearson_180423 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180423_pycharm.csv", header=FALSE, sep = ",")
adj_pearson_180423 <- as.matrix(adj_pearson_180423);
colnames(adj_pearson_180423) <- regions_180423;
rownames(adj_pearson_180423) <- regions_180423;
plot(adj_pearson_180423)
...
write.csv(conn_180423, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180423.csv");
sel_mat <- which(conn_180423 > quantile(conn_180423, .75), arr.ind = TRUE);
net_180423 <- network(conn_180423, directed = TRUE)
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_180423.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_180423, label = unique(rownames(conn_180423)) , edge.label = conn_180423, label.cex=2, edge.label.cex=2)
dev.off()
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/regionwise_evoked_180423.png"), units = "in",  width = 16, height = 16, res = 600)
circos.clear()
sectors = factor(tt, levels = tt)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 1))
...
i = 1;
for (day in days){
  df <- read_pzfx(path = "/home/antonio/Documents/tim_brown/analysis_network_GLMCC_v2.pzfx", 
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_171019.png", res=600,  units = "in",  width = 26, height = 16)
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_171207.png", res=600,  units = "in",  width = 26, height = 16)
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_171208.png", res=600,  units = "in",  width = 26, height = 16)
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_171213.png", res=600,  units = "in",  width = 26, height = 16)
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180110.png", res=600,  units = "in",  width = 26, height = 16)
...
adj_pearson_180111 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180111_pycharm.csv", header=FALSE)
adj_pearson_180111 <- as.matrix(adj_pearson_180111);
colnames(adj_pearson_180111) <- regions_180111;
rownames(adj_pearson_180111) <- regions_180111;
plot(adj_pearson_180111)
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180111.png", res=600,  units = "in",  width = 26, height = 16)
...
adj_pearson_180131 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180131_pycharm.csv", header=FALSE)
adj_pearson_180131 <- as.matrix(adj_pearson_180131);
colnames(adj_pearson_180131) <- regions_180131;
rownames(adj_pearson_180131) <- regions_180131;
plot(adj_pearson_180131)
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180131.png", res=600,  units = "in",  width = 26, height = 16)
...
adj_pearson_180221 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180221_pycharm.csv", header=FALSE)
adj_pearson_180221 <- as.matrix(adj_pearson_180221);
colnames(adj_pearson_180221) <- regions_180221;
rownames(adj_pearson_180221) <- regions_180221;
plot(adj_pearson_180221)
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180221.png", res=600,  units = "in",  width = 26, height = 16)
...
adj_pearson_180228 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180228_pycharm.csv", header=FALSE)
adj_pearson_180228 <- as.matrix(adj_pearson_180228);
colnames(adj_pearson_180228) <- regions_180228;
rownames(adj_pearson_180228) <- regions_180228;
plot(adj_pearson_180228)
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180228.png", res=600,  units = "in",  width = 26, height = 16)
...
adj_pearson_180302 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180302_pycharm.csv", header=FALSE)
adj_pearson_180302 <- as.matrix(adj_pearson_180302);
colnames(adj_pearson_180302) <- regions_180302;
rownames(adj_pearson_180302) <- regions_180302;
plot(adj_pearson_180302)
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180302.png", res=600,  units = "in",  width = 26, height = 16)
...
adj_pearson_180419 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180419_pycharm.csv", header=FALSE)
adj_pearson_180419 <- as.matrix(adj_pearson_180419);
colnames(adj_pearson_180419) <- regions_180419;
rownames(adj_pearson_180419) <- regions_180419;
plot(adj_pearson_180419)
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180419.png", res=600,  units = "in",  width = 26, height = 16)
...
adj_pearson_180420 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180420_pycharm.csv", header=FALSE)
adj_pearson_180420 <- as.matrix(adj_pearson_180420);
colnames(adj_pearson_180420) <- regions_180420;
rownames(adj_pearson_180420) <- regions_180420;
plot(adj_pearson_180420)
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180420.png", res=600,  units = "in",  width = 26, height = 16)
...
adj_pearson_180423 <- read.csv("/home/antonio/Documents/tim_brown/GLMCC/lightON_pycharm/result_GLMCC_lightON_180423_pycharm.csv", header=FALSE)
adj_pearson_180423 <- as.matrix(adj_pearson_180423);
colnames(adj_pearson_180423) <- regions_180423;
rownames(adj_pearson_180423) <- regions_180423;
plot(adj_pearson_180423)
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180423.png", res=600,  units = "in",  width = 26, height = 16)
...
write.csv(conn_diff_171019, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_171019.csv");
write.csv(conn_diff_171207, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_171207.csv");
write.csv(conn_diff_171208, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_171208.csv");
write.csv(conn_diff_171213, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_171213.csv");
write.csv(conn_diff_180110, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180110.csv");
write.csv(conn_diff_180111, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180111.csv");
write.csv(conn_diff_180131, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180131.csv");
write.csv(conn_diff_180221, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180221.csv");
write.csv(conn_diff_180228, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180228.csv");
write.csv(conn_diff_180302, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180302.csv");
write.csv(conn_diff_180419, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180419.csv");
write.csv(conn_diff_180420, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180420.csv");
write.csv(conn_diff_180423, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_180423.csv");
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_all.png", res=600,  units = "in",  width = 26, height = 16)
...
dev.off()
write.csv(conn_diff_all, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_all.csv");
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_all_day_reduced_circ.png", res=600,  units = "in",  width = 26, height = 16)
...
dev.off()
write.csv(conn_diff_all, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_all_day_reduced.csv");
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_all_night_reduced_circ.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_all_night, label = unique(rownames(conn_diff_all)), #edge.label = conn_diff_180423[conn_diff_180423>100], 
             label.cex = 2, edge.label.cex = 2, edge.lwd = conn_diff_all/100, usecurve=TRUE, arrowhead.cex = 1.2, vertex.cex = 1.5, pad = 1,
             mode = "circle", displayisolates = FALSE)
dev.off()
write.csv(conn_diff_all, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_diff_all_night_reduced.csv");
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_all_day_reduced_circ.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_all_ongoing_day, label = unique(rownames(conn_ongoing_day)), #edge.label = conn_diff_180423[conn_diff_180423>100], 
             ...
             mode = "circle", displayisolates = FALSE)
dev.off()
write.csv(conn_ongoing_day, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_all_day.csv");
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_all_night_reduced_circ.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_ongoing_night, label = unique(rownames(conn_ongoing_night)), #edge.label = conn_diff_180423[conn_diff_180423>100], 
             ...
             mode = "circle", displayisolates = FALSE)
dev.off()
write.csv(conn_ongoing_night, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_all_night.csv");
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_all_night_reduced_circ.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_all_evoked_day, label = unique(rownames(conn_evoked_day)), #edge.label = conn_diff_180423[conn_diff_180423>100], 
             ...
             mode = "circle", displayisolates = FALSE)
dev.off()
write.csv(conn_evoked_day, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_all_day.csv");
...
plot.network(net_evoked_night, label = unique(rownames(conn_evoked_night)), #edge.label = conn_diff_180423[conn_diff_180423>100], 
             ...
             mode = "circle", displayisolates = FALSE)
dev.off()
write.csv(conn_evoked_night, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_all_night.csv");
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoign_night_vs_day_circ.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_ongoing_night_vs_day, label = unique(rownames(conn_ongoing_day_vs_night)), #edge.label = conn_diff_180423[conn_diff_180423>100], 
             ...
             mode = "circle", displayisolates = FALSE)
dev.off()
write.csv(conn_ongoing_day_vs_night, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_ongoing_night_vs_day.csv");
...
png(file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_night_vs_day_circ.png", res=600,  units = "in",  width = 26, height = 16)
plot.network(net_evoked_night_vs_day, label = unique(rownames(conn_evoked_day_vs_night)), #edge.label = conn_diff_180423[conn_diff_180423>100], 
             ...
             mode = "circle", displayisolates = FALSE)
dev.off()
write.csv(conn_evoked_day_vs_night, file = "/home/antonio/Documents/tim_brown/GLMCC/conn_evoked_night_vs_day.csv");
...
conn_day_ongoing_vs_evoked = conn_ongoing_day - conn_evoked_day
conn_night_ongoing_vs_evoked = conn_ongoing_night - conn_evoked_night

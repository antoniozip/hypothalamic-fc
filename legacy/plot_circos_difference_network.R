...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/circos_conn_ongoing_day.png"), units = "in",  width = 12, height = 12, res = 1200)
circos.clear()
...
for(ii in 1:dim(ref_conn)[1]){
  for(jj in 1:dim(ref_conn)[2]){
    if (ref_conn[ii,jj] > median(values))
    {  
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/circos_conn_ongoing_night.png"), units = "in",  width = 12, height = 12, res = 1200)
circos.clear()
sectors = factor(all_region_labels, levels = all_region_labels)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 10))
...
# depth_values = 10;
# seq_values = seq(mean(values), max_values, (max_values - mean(values))/depth_values);
# col_fun_edges = colorRamp2(seq_values, carto.pal(pal1 = "blue.pal" , n1 = depth_values+1), transparency = 0.5)
...
########### With negative values, Day - Night during Ongoing activity
ref_conn = conn_ongoing_day_vs_night
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/circos_conn_ongoing_day_vs_night.png"), units = "in",  width = 12, height = 12, res = 1200)
circos.clear()
sectors = factor(all_region_labels, levels = all_region_labels)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 10))
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/circos_conn_evoked_day.png"), units = "in",  width = 12, height = 12, res = 1200)
circos.clear()
sectors = factor(all_region_labels, levels = all_region_labels)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 10))
...
for(ii in 1:dim(ref_conn)[1]){
  for(jj in 1:dim(ref_conn)[2]){
    ...
    {  
      circos.link(all_region_labels[ii], c(3,5), all_region_labels[jj] , c(3,5), directional = 0,  col = col_fun_edges_pos(ref_conn[ii,jj]*3),
                  lwd = (ref_conn[ii,jj]*2)/(max_values) )
    }
  }
}
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/circos_conn_evoked_night.png"), units = "in",  width = 12, height = 12, res = 1200)
circos.clear()
sectors = factor(all_region_labels, levels = all_region_labels)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 10))
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/circos_conn_evoked_day_vs_night.png"), units = "in",  width = 12, height = 12, res = 1200)
circos.clear()
sectors = factor(all_region_labels, levels = all_region_labels)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 10))
...
########### With negative values, Ongoing - Evoked during Day 
ref_conn = conn_evoked_day - conn_ongoing_day
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/circos_conn_day_ongoing_vs_evoked.png"), units = "in",  width = 12, height = 12, res = 1200)
circos.clear()
sectors = factor(all_region_labels, levels = all_region_labels)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 10))
...
png(file = paste0("/home/antonio/Documents/tim_brown/GLMCC/circos_conn_night_ongoing_vs_evoked.png"), units = "in",  width = 12, height = 12, res = 1200)
circos.clear()
sectors = factor(all_region_labels, levels = all_region_labels)
circos.par(cell.padding = c(0.02, 0, 0.02, 0))
circos.initialize(sectors, xlim = c(0, 10))
